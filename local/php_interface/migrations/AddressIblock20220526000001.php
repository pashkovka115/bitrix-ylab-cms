...
class AddressIblock20220526000001 extends Version
{
    protected $description = "Инфоблок адреса для контактов";
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()->saveIblock([
            ...
            'ELEMENT_ADD' => 'Добавить адрес',
            'ELEMENT_EDIT' => 'Изменить адрес',
            'ELEMENT_DELETE' => 'Удалить адрес',
